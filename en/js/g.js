...
function(t) {
    ...
    setup: {
        type_question: "Enter a query and click the search button",
        share_link: "Share a link:",
        or: "or"
    },
    play: {
        step_1: "Step 1. Enter a query.",
        step_2: "Step 2. Press the button.",
        pwnage: "Is it that hard?",
        nice: "It's easy!"
    },
    link: {
        creating: "Creating...",
    ...
    t ? function() {
        ...
        function r() {
            if (!$.getQueryString({
                ...
                var e = "//www.google.com/search?&rls=en&q=";
                o.attr("id") == $("#lucky").attr("id") && (e = "//www.google.com/search?hl=en&btnI=I%27m+Feeling+Lucky&q="), window.location = e + gentlyEncode(t)
            }
        }
